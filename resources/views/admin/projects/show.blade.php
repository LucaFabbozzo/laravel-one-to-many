...
@section('content')
    <div class="container w-75 m-auto text-center pt-2 text">
        ...
        <div class="card m-auto p-2 mb-5" style="width: 70%;">
         <img style="width: 40%" src="{{asset('storage/'. $project->cover_image)}}" class="card-img-top m-auto p-2 bg-dark" alt="{{$project->image_original_name}}">
            <div class="card-body">
                <h4 class="card-title fs-2">{{$project->name}} <span class="badge text-bg-info">{{ $project->type->name }}</span></h4>
